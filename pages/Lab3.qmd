...
This has already been done for you, with the following command:

::: {.callout-answer .icon .callout-note collapse=true}
```{sh, filename = 'sh'}
curl -L ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR313/030/SRR31398330/SRR31398330_1.fastq.gz -o Share/reads/MNase_20_R1.fq.gz
curl -L ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR313/030/SRR31398330/SRR31398330_2.fastq.gz -o Share/reads/MNase_20_R2.fq.gz
```
:::
...
samtools fixmate \
    ...
    --output-fmt bam \
    -r -m \
    Share/MNase/MNase_20.sam MNase_20.bam
