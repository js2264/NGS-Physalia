...
We will process two datasets from the Koszul lab, generated in 2024 and published [in Science](https://www.science.org/doi/10.1126/science.adm9466).
...
tinyMapper.sh --mode ATAC --sample Share/reads/ATAC_rep1 --genome ~/genomes/S288c/S288c --output Share/tm/ --threads 16
tinyMapper.sh --mode ATAC --sample Share/reads/ATAC_rep2 --genome ~/genomes/S288c/S288c --output Share/tm/ --threads 16
```
::: -->
